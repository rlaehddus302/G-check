        ...
        <div className="flex-grow-1 d-flex align-items-center justify-content-center">
            <section className="d-flex align-items-center justify-content-center py-4">
                <div>
                    ...
                    <div onClick={() => navigationHandler("graduation-check")} className={`d-grid gap-0 row-gap-4 border border-secondary-subtle bg-white rounded-4 shadow-sm py-3 mb-5 ${classes.box}`}>
